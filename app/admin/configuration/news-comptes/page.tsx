...
import { SaveUsers } from '@/app/services/UsersService';
...
export default function Page() {
    ...
    const [value, setValue] = useState(''); // ou null, selon tes besoins
                    ...
                    <form>
                        ...
                        <div className="relative mb-8 flex items-center justify-center gap-3">
                            ...
                            <div className="relative">
                                <Image
                                    ...
                                    alt="User"
                                    className="mb-3 h-35 w-35 border rounded-full"
                                    width={140}
                                    height={140} />
                        ...
                        {/* <div className="mb-5 col-span-5 xl:col-span-3"> */}
                            ...
                            <div className="flex justify-end gap-4.5 space-x-2">
                                ...
                                <button onClick={AddData} className="flex justify-center rounded bg-[#012340] py-2 px-4 font-medium text-white hover:bg-opacity-90" type="button" >
                                    Ajouter
                                </button>
