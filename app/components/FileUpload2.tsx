...
// Props pour le composant FileUpload2
interface Props {
    id: string | undefined; //
    titles: string;
...
const FileUpload2: React.FC<Props> = ({ id, fileObjects, setFileObjects,fetchProjectDetails}) => {
                ...
                <div key={index} className="flex flex-col gap-3 p-2">
                    ...
                    <div className="flex items-center gap-0">
                        ...
                        <div className="md:w-1/12 md:mt-4 md:ml-5 ml-2 mt-4">
                            <button className=" flex justify-center rounded bg-red-500 py-3 px-3 font-medium text-white hover:bg-opacity-90" type="button" onClick={() => handleRemove(index)}>
            ...
            <div className="md:w-12/12 mt-4 md:ml-4 flex justify-between">
                {Load ? (
                    ...
                    <div className="flex justify-left gap-2">
                        ...
                        <button onClick={addNewsFiles} className="flex justify-center border-xl rounded bg-[#012340] py-2 px-3 font-medium text-white hover:bg-opacity-90" type="submit">SAUVEGARDER </button>
                    </div>
                )}
            </div>
