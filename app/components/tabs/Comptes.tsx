            ...
            <section className="container px-8 mx-auto bg-white">
                    ...
                    <div className="border bg-white border-white px-2 mb-2">
                        <div className="flex-grow flex items-end justify-end p-2">
                            <a onClick={() => navigateTo(`/admin/configuration/news-comptes`)} className="rounded-xl border text-nowrap flex items-center gap-2 bg-[#012340] py-2 px-4 font-medium text-white hover:bg-opacity-90" >
                                        ...
                                        <tr key={user.userId}>
                                            ...
                                            <td className={`px-4 py-4 text-sm font-medium ${index % 2 === 0 ? 'bg-[#EBF1FA]' : 'bg-white'} text-gray-700 whitespace-nowrap`}>
                                                <div className="inline-flex items-center gap-x-3">
                                                    ...
                                                    <a onClick={() => navigateTo(`/admin/configuration/news-comptes/${user.userId}`)} className="focus:outline-none" aria-label="Icon 1">
