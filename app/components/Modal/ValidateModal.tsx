...
const ValidateModal: React.FC<ModalProps> = ({ buttonColor,actionMessage,onDeleteMessage,onCloseMessage, id, onDelete, isOpen,actions, onClose }) => {
                    ...
                    <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-4 md:p-5">
                        <div className="relative">
                            ...
                            <div className="p-4 md:p-5 text-center">
                                ...
                                <svg className="mx-auto mb-4 text-white w-12 h-12"
